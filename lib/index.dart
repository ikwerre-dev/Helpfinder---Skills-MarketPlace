...
export '/registeration/verify_mobile/verify_mobile_widget.dart'
...
export '/registeration/userdetails/userdetails_widget.dart'
...
export '/registeration/get_started/get_started_widget.dart'
    show GetStartedWidget;
export '/pages/main/search/search_widget.dart' show SearchWidget;
export '/pages/main/videos/videos_widget.dart' show VideosWidget;
